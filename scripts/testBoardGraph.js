...
console.log('Total Vertices:', board.vertices.length);
console.log('Total Edges:', board.edges.length);

const counts = {};
board.vertices.forEach((v) => {
  const edgeCount = v.adjacentEdgeIds.length;
  counts[edgeCount] = (counts[edgeCount] || 0) + 1;
});
console.log('Vertex Edge Count Distribution:', counts);
